    ...
    return(
        <>
            {/*{TracksData.map((tracks, index) => (*/}
                <div className='xl:mx-auto max-w-7xl lg:mx-[10vw] justify-items-center mx-[5vw] mt-[5vh] grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-16 justify-around' data-aos="fade-up">
                {/*<div key={index}>*/}
                {/*    new card*/}
                    <div>
