                    ...
                    <section className="border border-pracula rounded-lg shadow p-5">
                        <div className="mx-auto max-w-screen-md">
                            ...
                            <form action="#" className="space-y-8">
                                ...
                                <button type="submit" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center hover:text-dracxt rounded-lg hover:bg-pracula hover:border-2 hover:border-dracula bg-dracula border-2 border-pracula">Send Message</button>
                            </form>
                        </div>
                    </section>
                </div>
