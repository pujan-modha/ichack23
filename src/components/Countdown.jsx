    ...
    return (
        <div className="h-screen">
            <div className="flex flex-col items-center justify-center w-full h-full gap-6 sm:gap-16">
                <h1 className='bg-opacity-10 backdrop-blur-0 bg-pracula border-2 border-pracula text-dracxt rounded-3xl px-2.5 font-medium py-1'>Round-1 will begin in</h1>
