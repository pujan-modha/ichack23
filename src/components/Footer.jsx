                ...
                <div>
                    <footer className="">
                        <div className="w-full mx-auto md:py-8">
                            ...
                            <span className="block text-xs text-dracxt font-extralight mt-3 sm:text-center text-center pb-[1vh] md:pb-0">Made with <span className='text-pracula'><a href="https://draculatheme.com/" target="_blank" rel="noreferrer" className="animate-pulse">💜</a> </span><span>by </span><a href="https://www.linkedin.com/in/pujan-modha/" target='_blank' rel="noreferrer" className="hover:underline text-pracula">Pujan Modha</a><span> and </span><a href="https://www.linkedin.com/in/arunabha-mukhopadhyay" target='_blank' rel="noreferrer" className="hover:underline text-pracula">Arunabha M.</a></span>
                        </div>
                    </footer>
                </div>
            </>
